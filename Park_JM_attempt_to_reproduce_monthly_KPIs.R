...
#### perms2prods####
perms2prods<-read_xlsx("20220119_Permissionsets_mapped_to_Products.xlsx") # for Jan
...
df_fortable2 <- df_month[df_month$hed__Account__r.Name != "Student & Acad Technologies", ] 
