...
# user_counts_by_product<-rename(user_counts_by_product,
c("Product/Profile" = "Var1"))
# user_cts_by_prd_unit <- rename(user_cts_by_prd_unit,
c("Unit/Division" = "by", "Product/Profile" = "Var1"))
...
df_fortable <- df_fortable %>% 
  mutate(SFCreatedDate = lubridate::dmy_hms(Created.Date))
